...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  ...
  <title>付款成功页面</title> 
  <link rel="stylesheet" type="text/css" href="/Home/password/xiangmv/AmazeUI-2.4.2/assets/css/amazeui.css" /> 
  <link href="/Home/password/xiangmv/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css" /> 
  <link href="/Home/password/xiangmv/basic/css/demo.css" rel="stylesheet" type="text/css" /> 
  <link href="/Home/password/xiangmv/css/sustyle.css" rel="stylesheet" type="text/css" /> 
  <script type="text/javascript" src="/Home/password/xiangmv/basic/js/jquery-1.7.min.js"></script> 
 </head> 
 <body> 
  <!--顶部导航条 --> 
